                    ...
                    <form action="/addproblem" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" name="carnum" class="form-control" id="exampleFormControlInput1" placeholder="X 000 XX 00">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput2" class="form-label">Описание нарушения</label>
                                <input type="text" name="problem" class="form-control" id="exampleFormControlInput2">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput3" class="form-label">Фото нарушения</label>
                                <input type="file" name="file" class="form-control" id="exampleFormControlInput3">
                            </div>
                        </div>
